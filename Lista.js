...
function ListPerson() {
	...
	this.addAtPerson = function(person,index) {
		if (!(person instanceof Person)) { 
			throw "Not an instance of person";
		}
	...
	this.setPerson = function(person,index){
		if (!(person instanceof Person)) { 
			throw "Not an instance of person";
		}
		var susti;
...
/*function de testeo*/
 ...
 function testlist(){
	...
	console.log ("Prueba de set: " + list.toStringPerson(list.setPerson(persona7,2)));
	console.log ("Lista despues de set: " + list.toString());
    ...
    console.log ("Prueba de addAtPerson: " + list.addAtPerson(persona8,2));
    console.log ("Lista despues de addAtPerson: " + list.toString(list));
